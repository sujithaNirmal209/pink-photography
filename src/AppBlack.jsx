export default function PinkPhotographyWebsite() {
  ...
  return (
    <div className="min-h-screen bg-pink-50 text-gray-800 font-sans">
      ...
      {/* Navbar */}
      <nav className="flex items-center justify-between px-8 py-5 bg-white shadow-md sticky top-0 z-50 border-b border-pink-100">
      ...
      >
        ...
        <div className="relative z-10 px-6">
          ...
          <a
            href="https://wa.me/919876543210?text=Hi%20I%20want%20to%20book%20a%20photo%20session"
            target="_blank"
      ...
      >
        ...
        <div>
          <h3 className="text-4xl font-bold text-pink-600 mb-6">
            About Pink Photography
          </h3>

          <p className="text-lg leading-8 text-gray-700">
            Pink Photography is a modern photography brand focused on creating
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <h4 className="text-2xl font-bold text-pink-600 mb-3">
                {service}
              </h4>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h3 className="text-5xl font-bold text-pink-600 mb-14">
            Happy Clients
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-pink-50 p-8 rounded-3xl shadow-lg">
              <p className="text-gray-700 leading-8">
                “Absolutely amazing photography. Our wedding memories became magical.”
              </p>

              <h4 className="mt-6 text-xl font-bold text-pink-600">
                — Priya & Karthik
              </h4>
            </div>
            ...
            <div className="bg-pink-50 p-8 rounded-3xl shadow-lg">
              <p className="text-gray-700 leading-8">
                “Very professional team and beautiful editing quality.”
              </p>
            ...
            <div className="bg-pink-50 p-8 rounded-3xl shadow-lg">
              <p className="text-gray-700 leading-8">
                “The best photography experience we ever had.”
              </p>
      ...
      <section
        id="contact"
        className="bg-gradient-to-r from-pink-300 via-pink-400 to-pink-500 py-20 px-6 text-white"
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-col items-center">
            ...
            <div className="space-y-4 text-lg">
              <p>📍 Chennai, India</p>
              <p>📞 +91 98765 43210</p>
              <p>📧 pinkphotography@gmail.com</p>
              <p>📸 Instagram: @pinkphotography</p>
              <p>🌐 www.pinkphotography.com</p>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-10 bg-yellow-400 text-pink-900 px-8 py-4 rounded-full text-lg font-bold hover:bg-yellow-300 transition shadow-xl"
            >
              Contact Now
            </a>
      ...
      {/* Footer */}
      <footer className="bg-pink-900 text-pink-100 py-6 text-center text-sm">
        © 2026 Pink Photography • www.pinkphotography.com • All Rights Reserved
      </footer>
